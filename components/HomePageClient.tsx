...
import { trackCTAClick, trackProductClick, trackExternalLink, trackPhoneClick } from "@/lib/gtag";
        ...
        <div className="max-w-7xl mx-auto px-4 py-20 md:py-32 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              ...
              onClick={() => trackCTAClick("hero_start_your_journey", "/contact")}
            >
              Start Your Journey
            </Link>
            <a
              ...
              onClick={() => trackCTAClick("hero_shop_products", "https://weight-loss-shakes.goherbalife.com")}
            >
              Shop Products
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {productCategories.map((cat) => (
              <a
                ...
                onClick={() => trackProductClick(cat.title)}
              >
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mt-8">
            <a
              ...
              onClick={() => trackCTAClick("browse_all_products", "https://weight-loss-shakes.goherbalife.com")}
            >
              Browse All Products
            </a>
          </div>
          ...
          <div className="bg-gradient-to-r from-herbalife-orange to-orange-500 rounded-2xl p-8 md:p-12 text-white">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <Link
                ...
                onClick={() => trackCTAClick("be_your_own_boss_learn_more", "/business-opportunity")}
              >
                Learn More
              </Link>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              onClick={() => trackCTAClick("ready_to_start_contact", "/contact")}
            >
              Contact Us
            </Link>
            <a
